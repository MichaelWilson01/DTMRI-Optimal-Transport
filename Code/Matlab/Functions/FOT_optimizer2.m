...
%           obj.C = C;
      ...
      function optimize_step(obj)
          ...
          obj.T = obj.V(:,1:obj.k_y) * obj.Lambda *obj.U(:,1:obj.k_x)';  
      end
      
      function Lambda = initialize_lambda(obj,U,V,k_x,k_y)
          Lambda = V(:,1:k_y)'*U(:,1:k_x);
      end
      
      
      function optimize(obj)
          if isempty(obj.Lambda)
              obj.Lambda = obj.initialize_lambda(obj.U,obj.V,obj.k_x, obj.k_y);
          end
          %obj.reduce_basis()
